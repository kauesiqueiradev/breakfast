                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [
                                diets[index].viewSelected ? const Color(0xff9DCEFF) : Colors.transparent,
                                diets[index].viewSelected ? const Color(0xff92A3FD) : Colors.transparent,
                              ]
                            ),
                          ...
                          child: Center(
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 14,
                                color: diets[index].viewSelected ? Colors.white : const Color(0xffC58BF2),
                                fontWeight: FontWeight.w600
                              ),
                            ),
                          )
